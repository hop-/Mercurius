...
void Frame::
prepareToDraw(const GuiObject* object)
{
    assert(0 != object);
...
void Frame::
setScreenMode(ScreenMode m)
{
    m_screenMode = m;
}

Frame::ScreenMode Frame::
screenMode() const
{
    return m_screenMode;
}
...
void Frame::
setLayersViewMode(LayersViewMode m)
{
    m_layersViewMode = m;
}

Frame::LayersViewMode Frame::
layersViewMode() const
{
...
void Frame::
setMsPerUpdate(const unsigned& ms)
{
    m_msPerUpdate = ms;
}
